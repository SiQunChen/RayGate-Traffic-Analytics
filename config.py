...
#  當您需要更換資料集或調整分析目標時，
#  請直接修改這個檔案中的設定，然後重新執行 run_all_analyses.py 即可。
#
# =============================================================================
...
# 乘客分群分析的輸出資料夾名稱
CLUSTER_OUTPUT_DIR = 'clustering_results'
...
# 台鐵分析的目標車站區間 (例如：從彰化到嘉義)
# 如果要分析花蓮地區，可以修改成花蓮的車站列表
TRA_TARGET_STATIONS = [
    # 彰化縣
...
# 注意：這裡是資料夾，因為該腳本會讀取資料夾內所有 Excel 檔
